...
function getTopDomains() {
    $lines = file('https://sedo.com/txt/topdomains_us.txt');
    $topDomains = array();
...
<!-- <table style="border: 0 none; background-color: #e0e8ef; border-collapse: separate; border-spacing: 1px">
    ...
    <tr>
        <td style="background-color: #fafafa; padding: 5px 10px;">
            <a href="https://sedo.com/search/details/?campaignId=328637&language=us&domain=<?php echo $domain[0]; ?>" target="_blank" style="font-size:14px;">
                <?php echo $domain[0]; ?>
            </a>
        </td>
